...
public class Wait {
    ...
    //private WebDriverWait waitTimeoutMilliseconds;
    //private WebDriverWait sleepingWait;
    //private WebDriverWait sleepingWaitTimeoutMilliseconds;
    private WebDriver driver;

    public Wait(WebDriver webDriver) {
        this.driver = webDriver;
        //this.wait = new WebDriverWait(webDriver, DEFAULT_TIMEOUT);
        //this.waitTimeoutMilliseconds = new WebDriverWait(webDriver, DEFAULT_TIMEOUT_MILLISECONDS, TimeUnit.MILLISECONDS);
        //this.sleepingWait = new WebDriverWait(webDriver, DEFAULT_TIMEOUT, DEFAULT_SLEEP);
        //this.sleepingWaitTimeoutMilliseconds = new WebDriverWait(webDriver, DEFAULT_TIMEOUT_MILLISECONDS, TimeUnit.MILLISECONDS, DEFAULT_SLEEP_MILLISECONDS);
    }
    ...
    /*public WebElement forElementPresent(By by, boolean failOnTimeout) {
        ...
        try {
            ...
            if (failOnTimeout) {
                PageObjectLogging.logInfo(ELEMENT_PRESENT_MESSAGE
    ...
    /*public WebElement forElementPresent(By by, int timeout) {
        ...
        try {
            ...
            PageObjectLogging.logInfo(ELEMENT_PRESENT_MESSAGE + " " + e);
            throw e;
        } finally {
            restoreDeaultImplicitWait();
        }
   ...
   /*public WebElement forElementVisible(WebElement element, int timeoutSec, int polling) {
    ...
    /**
     * use method with Duration object except int
     */
    /*@Deprecated
    ...
    /*public void forX(Duration duration) {
        ...
        try {
            ...
            //PageObjectLogging.logInfo("Wait.forXMilliseconds", e, false);
        }
    }*/
...
//                .until(ExpectedConditions.invisibilityOfElementLocated(by)); // isDisplayed method raises "Returned value cannot be converted to Boolean: {message=javascript error: Argument to isShown must be of type Element"
//    }
...
//                .until(new ExpectedConditionElementToBeInvisible(by));
    ...
    public WebElement forElementThatChangesProperty(WebElement webElement, String attributeName, String expectedValueAttribute, int timeout){
        return new WebDriverWait(driver, timeout, TimeUnit.MILLISECONDS, DEFAULT_SLEEP_MILLISECONDS)
    ...
    public WebElement forElementThatChangesProperty(By by, String attributeName, String expectedValueAttribute, int timeout){
        return new WebDriverWait(driver, timeout, TimeUnit.MILLISECONDS, DEFAULT_SLEEP_MILLISECONDS)
