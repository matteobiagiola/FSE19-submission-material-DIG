...
public class BasePageObject {
    ...
    public void typeWithoutClearing(By locator, String input){
        WebElement element = this.findElementSafely(locator);
    ...
    * */
    ...
    public boolean waitForElementThatChangesProperty(WebElement webElement, String attributeName, String expectedValueAttribute, int timeOut) {
        try {
    ...
    public boolean waitForElementThatChangesProperty(By locator, String attributeName, String expectedValueAttribute, int timeout) {
        try {
            wait.forElementThatChangesProperty(locator, attributeName, expectedValueAttribute, timeout);
            return true;
        } catch (TimeoutException e) {
