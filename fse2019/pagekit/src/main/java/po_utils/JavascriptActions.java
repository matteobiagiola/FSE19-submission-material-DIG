...
public class JavascriptActions {
    ...
    public void sendKeys(WebElement element, String text){
        js.executeScript("$(arguments[0])[0].value='" + text + "'", element);
    }

    public void sendKeys(WebElement element, CharSequence text){
        js.executeScript("$(arguments[0])[0].value='" + text.subSequence(0, text.length()) + "'", element);
    }

    public void focusOnElement(WebElement element){
        js.executeScript("$(arguments[0])[0].focus();", element);
    }


    public String getAttribute(WebElement element, String attributeName){
        String attribute = (String) js.executeScript("return $(arguments[0])[0].getAttribute('" + attributeName + "')",element);
        return attribute;
    }
