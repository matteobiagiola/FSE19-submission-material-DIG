...
public class EditEventComponent extends BasePageObject implements PageComponent {

	/**
	 * Page Object for EditEvent (state177) --> AddEditEventContainerPage
	 */
	public EditEventComponent(WebDriver driver) {
		super(driver);
	}

	public void goToConfirmDeletionPage() {
