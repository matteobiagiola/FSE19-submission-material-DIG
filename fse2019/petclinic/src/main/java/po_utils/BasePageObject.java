...
public class BasePageObject {
    ...
    public void bruteForceClick(By elementToClick, By elementOnTheSamePage, int maxAttempts, String errorMessage){
        this.clickOn(elementToClick);
//        boolean elementToClickNotFound = false;
//        while(!this.waitForElementBeingInvisibleOnPage(elementOnTheSamePage, 1000)
//                && maxAttempts > 0){
//            if(this.waitForElementBeingPresentOnPage(elementToClick, 1000)){
//                this.clickOn(elementToClick);
//            }else{
//                elementToClickNotFound = true;
//            }
//            maxAttempts--;
//        }
//        if(maxAttempts == 0){
//            throw new IllegalStateException("bruteForceClick - "
//                    + errorMessage + "; elementToClickNotFound " + elementToClickNotFound);
//        }
    }
    ...
    //test if it works with evosuite
    public void pressKeyboardEnter(WebElement element){
        //this.jsActions.pressKeyEnterOnElement(element);
    ...
    public List<WebElement> getOptionsInDropdown(By locatorDropdown){
        WebElement dropdown = this.findElementSafely(locatorDropdown);
        return this.jsActions.getDropdownOptions(dropdown);
    }
    ...
    * */
    ...
    public Alert waitForAlertBeingPresentOnPage(){
        try{
            return wait.forAlertBeingPresent();
        }catch (TimeoutException e){
            PageObjectLogging.logInfo("waitForAlertBeingPresentOnPage timeout exception: unable to locate the alert");
            return null;
        }
    }
...
//    }
    ...
    public boolean waitForElementWhosePropertyDisappears(WebElement webElement, String attributeName, String defaultValueAttribute) {
        try {
            ...
            PageObjectLogging.logInfo("waitForElementWhosePropertyDisappears timeout exception");
            return false;
        }
    }
    ...
    public boolean waitForElementWhosePropertyDisappears(By locator, String attributeName, String defaultValueAttribute) {
        try {
            ...
            PageObjectLogging.logInfo("waitForElementWhosePropertyDisappears timeout exception: unable to locate the element " + locator.toString());
            return false;
        }
    }
    ...
    public boolean waitForElementThatChangesProperty(WebElement webElement, String attributeName, String expectedValueAttribute) {
        try {
            ...
            PageObjectLogging.logInfo("waitForElementThatChangesProperty timeout exception");
            return false;
        }
    }
    ...
    public boolean waitForElementThatChangesProperty(By locator, String attributeName, String expectedValueAttribute) {
        try {
            ...
            PageObjectLogging.logInfo("waitForElementThatChangesProperty timeout exception: unable to locate the element " + locator.toString());
            return false;
        }
    }
    ...
    public boolean waitForElementThatChangesText(By locator, boolean textExpected, String text) {
        try {
            ...
            PageObjectLogging.logInfo("waitForElementThatChangesText timeout exception: unable to locate the element " + locator.toString());
            return false;
        }
    }
    ...
    public boolean waitForElementBeingClickable(By locator) {
        try {
            ...
            PageObjectLogging.logInfo("waitForElementToBeClickable timeout exception: unable to locate the element " + locator.toString());
            return false;
        }
    }
