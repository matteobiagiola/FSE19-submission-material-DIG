...
public class JavascriptActions {
    ...
    public void selectOptionInDropdown(WebElement dropdown, String optionToSelectByStringValue){
        ...
        throw new IllegalStateException("Option " + optionToSelectByStringValue + " is not present");
    }

    public List<WebElement> getDropdownOptions(WebElement dropdown){
        return (List<WebElement>) js.executeScript("return arguments[0].options", dropdown);
    }
