...
public class TestGeneration {
	...
	public static Option[] getOptions(){
		return new Option[]{
				...
				new Option("generateAdaptiveRandom", "use adaptive random test generation"),
				new Option("generateCustomRandom", "use custom random test generation (random search with an ALGORITHM)"),
	...
	private static Strategy getChosenStrategy(List<String> javaOpts, CommandLine line) {
		...
		} else if (line.hasOption("generateCustomRandom")) {
			strategy = Strategy.CUSTOM_RANDOM;
		} else if (line.hasOption("generateAdaptiveRandom")) {
			strategy = Strategy.ADAPTIVE_RANDOM;
	...
	private static List<List<TestGenerationResult>> generateTests(Properties.Strategy strategy, String target,
		...
		case ADAPTIVE_RANDOM:
			cmdLine.add("-Dstrategy=Adaptive_Random");
			break;
		case CUSTOM_RANDOM:
			cmdLine.add("-Dstrategy=Custom_Random");
			break;
		case RANDOM_FIXED:
