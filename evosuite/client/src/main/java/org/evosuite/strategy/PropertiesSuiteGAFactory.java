...
import org.evosuite.ga.metaheuristics.art.AdaptiveRandomSearch;
...
import org.evosuite.testcase.factories.SeleniumTestChromosomeFactory;
...
public class PropertiesSuiteGAFactory extends PropertiesSearchAlgorithmFactory<TestSuiteChromosome> {
	...
	protected ChromosomeFactory<TestSuiteChromosome> getChromosomeFactory() {
		...
		case EVOSUITE:
			...
			case ALLMETHODS:
				...
				/*return new TestSuiteChromosomeFactory(
				        new SeleniumTestChromosomeFactory());*/
			case RANDOM:
	...
	protected GeneticAlgorithm<TestSuiteChromosome> getGeneticAlgorithm(ChromosomeFactory<TestSuiteChromosome> factory) {
		...
		case CUSTOM_RANDOM:
			logger.info("Chosen search algorithm: CUSTOM_RANDOM");
			return new CustomRandomSearch<TestSuiteChromosome>(factory);
        case NSGAII:
		...
		case ADAPTIVE:
			logger.info("Chosen search algorithm: ADAPTIVE");
			return new AdaptiveRandomSearch<TestSuiteChromosome>(factory);
		default:
	 ...
	 * @return a {@link SecondaryObjective} object.
	 */
