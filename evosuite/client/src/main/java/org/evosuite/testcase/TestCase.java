...
public interface TestCase extends Iterable<Statement>, Cloneable,
	...
	/**
	 * Check if the test case is minimized (selenium page object)
	 *
	 * @return a boolean
	 */
	...
	/**
	 * Set if the test case is minimized (selenium page object)
	 *
	 * @param isMinimized, a boolean
	 */
	public void setMinimized(boolean isMinimized);

	/**
	 * Check if minimization for this test cased failed (selenium page object)
	 *
	 * @return a boolean
	 */
	...
	/**
	 * Set if minimization for this test case failed (selenium page object)
	 *
	 * @param isMinimized, a boolean
	 */
