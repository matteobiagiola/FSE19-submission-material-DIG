    ...
    public boolean mutate(TestCase test, TestFactory factory) {
        ...
        while (value == oldVal && value != null) {
            if (Randomness.nextDouble() <= Properties.RANDOM_PERTURBATION) {
                ...
                delta();
        	/*if(this instanceof IntPrimitiveStatement){
        		IntPrimitiveStatement intPrimitiveStatement = (IntPrimitiveStatement) this;
        		if (Randomness.nextDouble() <= pl) {
        			logger.debug("@@@@int increment");
        			intPrimitiveStatement.increment();
        		}
        		if (Randomness.nextDouble() <= pl) {
        			logger.debug("@@@@int decrement");
        			intPrimitiveStatement.decrement();
        		}
        		if (Randomness.nextDouble() <= pl) {
        			logger.debug("@@@@int delta");
        			delta();
        		}
        	}*/
        }
