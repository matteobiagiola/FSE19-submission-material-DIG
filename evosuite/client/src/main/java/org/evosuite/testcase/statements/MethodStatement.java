...
public class MethodStatement extends EntityWithParametersStatement {
	...
	private boolean exceptionThrownBoolean;
	...
	private void init(GenericMethod method, VariableReference callee) throws IllegalArgumentException {
		...
		this.exceptionThrownBoolean = false;
	}
			...
			return super.exceptionHandler(new Executer() {
				...
				public void execute() throws InvocationTargetException,
					...
					try {
						...
						//logger.debug("Method scope: " + scope.toString());
					...
					//logger.debug("?????Method statement Driver state: {}",Driver.driver);
					//logger.debug("?????Callee object: {}",callee_object);
	...
	public Statement copy(TestCase newTestCase, int offset) {
		...
		m.setExceptionThrownBoolean(this.isExceptionThrownBoolean());
	...
	public boolean isExceptionThrownBoolean() {
		return exceptionThrownBoolean;
	}

	public void setExceptionThrownBoolean(boolean exceptionThrownBoolean) {
		this.exceptionThrownBoolean = exceptionThrownBoolean;
	}
}
