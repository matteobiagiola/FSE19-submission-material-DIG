...
public class NullStatement extends PrimitiveStatement<Void> {
	...
	public Throwable execute(Scope scope, PrintStream out)
		...
		if(this.injectDriverInstance()) 
		{
			logger.debug("!!!Injecting driver: {}",Scope.driver);
			Object ret = Scope.driver;
			try {
	...
	private boolean injectDriverInstance()
	{
		int i = 0;
		while(true){
			try{
				logger.debug("@@Statement: {}",tc.getStatement(i));
				/*if(tc.getStatement(i).getReturnValue()
						.getType().toString()
						.equals("class org.openqa.selenium.chrome.ChromeDriver")) return true;*/
				i++;
