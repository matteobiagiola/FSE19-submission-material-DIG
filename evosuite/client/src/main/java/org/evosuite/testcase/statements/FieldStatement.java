		...
		try {
			return super.exceptionHandler(new Executer() {
				...
				public void execute() throws InvocationTargetException,
					...
					try {
						//logger.debug(".....FieldStatement scope: {}",scope);
					...
					//logger.debug("@@SourceObject: {}",source_object);
					...
					try {
						...
						/*if(field.getFieldType().toString().equals("class org.openqa.selenium.chrome.ChromeDriver"))
						{
							ret = Scope.driver;
						}
