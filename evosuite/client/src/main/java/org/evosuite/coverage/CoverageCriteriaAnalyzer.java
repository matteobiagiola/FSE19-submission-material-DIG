...
//        if(Properties.FALSE_GOALS){
//        	OnlyBranchCoverageFactory branchFactory = new OnlyBranchCoverageFactory();
//        	goals.clear();
//        	for(OnlyBranchCoverageTestFitness goal: branchFactory.getInteresingCoverageGoals()){
//        		goals.add(goal);
//        	}
//        }
