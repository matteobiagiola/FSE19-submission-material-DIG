...
public class ClientProcess {
	...
	public void run() {
		...
		/*System.setProperty("webdriver.chrome.driver","/Users/matteobiagiola/Downloads/chromedriver");
	...
	private static void setupRuntimeProperties(){
		...
		RuntimeSettings.mockSystemCurrentTimeMillis = Properties.MOCK_SYSTEM_MILLIS;
		RuntimeSettings.maxSleepTime = Properties.MAX_SLEEP_TIME;
