...
public class RuntimeSettings {
    ...
    /**
     * During Selenium test cases should System.currentTimeMillis() be mocked
     * */
    public static boolean mockSystemCurrentTimeMillis = true;

    /**
     * During Selenium test cases max time a thread can sleep in ms
     * */
    public static int maxSleepTime = 50;
